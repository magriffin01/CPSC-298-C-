...
d. Course Number: 298-09
e. Assignment or Exercise Number: Assignment 2

2. A LIST OF ALL SOURCE FILES SUBMITTED FOR THIS ASSIGNMENT
a. Problem(intarray).cpp
b. Problem(zeroboth).cpp
c. Problem(salestax).cpp
d. Problem(conversion).cpp
...
a. Compile each cpp file using g++ [name of file].cpp or g++ *.cpp
b. Run the cpp files using ./a.out
